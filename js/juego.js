...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 160, 170, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 230, 450, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 230, 480, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 840, 130, 30, 15, 3),
    new Obstaculo('imagenes/auto_verde_abajo.png', 420, 390, 15, 30, 3),
    new Obstaculo('imagenes/valla_vertical.png', 450, 115, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 770, 230, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 80, 280, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 500, 480, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 850, 370, 30, 30, 2),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 300, 100, 10, 10, 1, { desdeX: 250, hastaX: 580, desdeY: 150, hastaY: 300 }),
    new ZombieCaminante('imagenes/zombie2.png', 50, 310, 10, 10, 1, { desdeX: 50, hastaX: 200, desdeY: 100, hastaY: 300 }),
    new ZombieCaminante('imagenes/zombie3.png', 200, 400, 10, 10, 1.5, { desdeX: 200, hastaX: 600, desdeY: 370, hastaY: 477 }),
    new ZombieCaminante('imagenes/zombie4.png', 750, 200, 10, 10, 1, { desdeX: 750, hastaX: 900, desdeY: 100, hastaY: 300 }),
    ...
    new ZombieConductor('imagenes/tren_horizontal.png', 120, 322, 90, 30, 2.5, { desdeX: 0, hastaX: 870, desdeY: 322, hastaY: 322 }, 'h'),
  ]
...
Juego.dibujar = function () {
  ...
  Dibujante.dibujarRectangulo('green', 759, 530, 128, 10);
